    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 font-uber_regular" role="alert">
                    <ul>
                ...
                @endif
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl ">Pengembalian Mobil</h1>
            </div>
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 ">
                <div class="flex items-center mb-4 sm:mb-0">
                    <form class="sm:pr-3" action="{{route('dashboard.return.cek')}}" method="GET">
                        <label for="products-search" class="">Plat nomor mobil</label>
        ...
        <div class="overflow-x-auto">
            <div class="inline-block min-w-full align-middle">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    @include('component.pengembalian_mobil.table', ['cars'=>$cars])
                </div>
            </div>
        </div>
    </div>
