<!-- Main modal -->
<div id="addcars-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="addcars-modal">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="{{route('dashboard.manajemen.store')}}">
                @csrf
                @method('post')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="merk" id="merk"
                            ...
                            placeholder="Masukkan merk mobil" required="">
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="number" name="plat_nomor" id="plat_nomor"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                            placeholder="Masukkan plat nomor mobil" required="">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="harga_perhari" id="harga_perhari"
                            ...
                            placeholder="Masukkan harga perhari" required="">
                    </div>
                </div>
                <button type="submit"
